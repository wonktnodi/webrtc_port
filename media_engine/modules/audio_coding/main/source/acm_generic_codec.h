...
#include "modules/audio_coding/main/source/acm_common_defs.h"
...
class ACMGenericCodec {
 public:
  ...
  ///////////////////////////////////////////////////////////////////////////
  // SetMaxConsecutiveCng()
  // Set the max count for CNG processing, if consecutive CNG reached the
  // threshold, engine will stop send CNG packet.
  void SetMaxConsecutiveCng(int cnt) { max_consective_cn_cnt_ = cnt; }

  int GetMaxConsectutiveCng() const { return max_consective_cn_cnt_; }
 ...
 protected:
  ...
  int consecutive_cn_cnt_;
  int max_consective_cn_cnt_;
  bool is_master_;
