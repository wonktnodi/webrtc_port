/****************************************************************************
 ...
 $Id: adj_thr.c,v 1.1.2.6 2004/02/16 20:02:18 ehr Exp $
 
****************************************************************************/
/*!
  \file
  \brief  adjust thresholds $Revision: 1.1.2.6 $
                              ...
                              AH_PARAM *ahParam)
{
  ...
  FLC_sub_start("initAvoidHoleFlag");
                             ...
                             const float redVal)
{
   ...
   FLC_sub_start("reduceThresholds");
                                ...
                                MINSNR_ADAPT_PARAM *msaParam)
{
   ...
   FLC_sub_start("adaptThresholdsToPe");
                                ...
                                ATS_ELEMENT     *adjThrChan)
{
   ...
   FLC_sub_start("bitresCalcBitFac");
...
static void calcPeCorrection(float *correctionFac,
                             ...
                             const int bitsLast) 
{
  FLC_sub_start("calcPeCorrection");
                      ...
                      const int         sideInfoBits)
{
   ...
   FLC_sub_start("AdjustThresholds");
