/****************************************************************************
 ...
 $Id: bit_cnt.c,v 1.1.2.2 2004/02/16 20:02:18 ehr Exp $
 
****************************************************************************/
/*!
  \file
  \brief  Huffman Bitcounter & coder $Revision: 1.1.2.2 $
  \author M. Werner
*/
#include <stdlib.h>
#include "bit_cnt.h"
                                         ...
                                         int       *bitCount)
{
  ...
  FLC_sub_start("count1_2_3_4_5_6_7_8_9_10_11");
                                     ...
                                     int       *bitCount)
{
  ...
  FLC_sub_start("count3_4_5_6_7_8_9_10_11");
                                 ...
                                 int       *bitCount)
{
  ...
  FLC_sub_start("count5_6_7_8_9_10_11");
                             ...
                             int       *bitCount)
{
  ...
  FLC_sub_start("count7_8_9_10_11");
...
const static COUNT_FUNCTION countFuncTable[CODE_BOOK_ESC_LAV+1] =
{
...
{
   FLC_sub_start("bitCountScalefactorDelta");
   MOVE(1);
   FLC_sub_end();
...
int codeScalefactorDelta(signed int delta, HANDLE_BIT_BUF hBitstream)
{
  ...
  FLC_sub_start("codeScalefactorDelta");
