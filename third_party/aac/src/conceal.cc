/****************************************************************************
 ...
 $Id: conceal.c,v 1.1.2.8 2004/04/01 07:31:12 ehr Exp $

****************************************************************************/
/*!
  \file
  \brief  independent channel concealment  $Revision: 1.1.2.8 $
...
void CConcealment_Init (CAacDecoderStaticChannelInfo *pAacDecoderStaticChannelInfo)
{
  ...
  FLC_sub_start("CConcealment_Init");
                         ...
                         char FrameOk)
{
  ...
  FLC_sub_start("CConcealment_Apply");
                                   ...
                                   float *spec)
{
  ...
  FLC_sub_start("CConcealment_ApplyRandomSign");
                                  ...
                                  float                  *sfbEnergy)
{
  ...
  FLC_sub_start("CConcealment_CalcBandEnergy");
...
void CConcealment_UpdateState(CConcealmentInfo *pConcealmentInfo,
                              int FrameOk)
{
  FLC_sub_start("CConcealment_UpdateState");
