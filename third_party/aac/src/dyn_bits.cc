/****************************************************************************
 ...
 $Id: dyn_bits.c,v 1.1.2.7 2004/05/30 13:57:40 ehr Exp $
 
****************************************************************************/
/*!
  \file
  \brief  Noiseless coder module  $Revision: 1.1.2.7 $
  \author M.Werner
*/
#include <stdlib.h>
#include <limits.h>
                 ...
                 int blockType)
{
  ...
  FLC_sub_start("calcSideInfoBits");
...
findMinMergeBits(const int *bc1, const int *bc2)
{
  ...
  FLC_sub_start("findMinMergeBits");
                 ...
                 const int blockType)
{
  ...
  FLC_sub_start("noiselessCounter");
  ...
  case STOP_WINDOW:
    ...
    MOVE(1);
    sideInfoTab = sectionData->sideInfoTabLong;
    break;
  case SHORT_WINDOW:

    MOVE(1);
    sideInfoTab = sectionData->sideInfoTabShort;
    break;
  }
