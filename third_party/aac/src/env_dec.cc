/****************************************************************************
 ...
 $Id: env_dec.c,v 1.1.2.3 2004/02/17 15:36:16 jr Exp $

****************************************************************************/
/*
  \file
  \brief  envelope decoding $Revision: 1.1.2.3 $
...
static void decodeEnvelope (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
...
static void sbr_envelope_unmapping (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
...
static void requantizeEnvelopeData (HANDLE_SBR_FRAME_DATA h_sbr_data,
                                    int ampResolution);
static void deltaToLinearPcmEnvelopeDecoding (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                                              HANDLE_SBR_FRAME_DATA h_sbr_data,
                                              HANDLE_SBR_PREV_FRAME_DATA h_prev_data);
static void decodeNoiseFloorlevels (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                                    HANDLE_SBR_FRAME_DATA h_sbr_data,
                                    HANDLE_SBR_PREV_FRAME_DATA h_prev_data);
static void timeCompensateFirstEnvelope (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                                         HANDLE_SBR_FRAME_DATA h_sbr_data,
                                         HANDLE_SBR_PREV_FRAME_DATA h_prev_data);
static int checkEnvelopeData (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                              HANDLE_SBR_FRAME_DATA h_sbr_data,
                              HANDLE_SBR_PREV_FRAME_DATA h_prev_data);
...
*/
void
decodeSbrData (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
               HANDLE_SBR_FRAME_DATA h_data_left,
...
*/
static void
sbr_envelope_unmapping (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                        HANDLE_SBR_FRAME_DATA h_data_left,
                        HANDLE_SBR_FRAME_DATA h_data_right)
{
  int i;
  ...
  FLC_sub_start("sbr_envelope_unmapping");
  ...
  for (i = 0; i < hHeaderData->FreqBandData.nNfb * h_data_left->frameInfo.nNoiseEnvelopes; i++) {
    ...
    TRANS(2);
    tempL = (float) pow(2.0f, tempL);
    tempR = (float) pow(2.0f, tempR);
...
*/
static void
leanSbrConcealment(HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                   HANDLE_SBR_FRAME_DATA  h_sbr_data,
                   HANDLE_SBR_PREV_FRAME_DATA h_prev_data
                   )
{
  ...
  FLC_sub_start("leanSbrConcealment");
...
*/
static void
decodeEnvelope (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                HANDLE_SBR_FRAME_DATA  h_sbr_data,
                HANDLE_SBR_PREV_FRAME_DATA h_prev_data,
...
*/
static int
checkEnvelopeData (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                   HANDLE_SBR_FRAME_DATA h_sbr_data,
                   HANDLE_SBR_PREV_FRAME_DATA h_prev_data
                   )
{
  ...
  FLC_sub_start("checkEnvelopeData");
...
*/
static void
limitNoiseLevels(HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                 HANDLE_SBR_FRAME_DATA h_sbr_data)
{
  int i;
  ...
  FLC_sub_start("limitNoiseLevels");
...
*/
static void
timeCompensateFirstEnvelope (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                             HANDLE_SBR_FRAME_DATA h_sbr_data,
                             HANDLE_SBR_PREV_FRAME_DATA h_prev_data)
{
  int i, nScalefactors;
  ...
  FLC_sub_start("timeCompensateFirstEnvelope");
...
requantizeEnvelopeData (HANDLE_SBR_FRAME_DATA h_sbr_data, int ampResolution)
{
  ...
  FLC_sub_start("requantizeEnvelopeData");
...
*/
static void
deltaToLinearPcmEnvelopeDecoding (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                                  HANDLE_SBR_FRAME_DATA h_sbr_data,
                                  HANDLE_SBR_PREV_FRAME_DATA h_prev_data)
{
  ...
  FLC_sub_start("deltaToLinearPcmEnvelopeDecoding");
...
*/
static void
decodeNoiseFloorlevels (HANDLE_SBR_HEADER_DATA_DEC hHeaderData,
                        HANDLE_SBR_FRAME_DATA h_sbr_data,
                        HANDLE_SBR_PREV_FRAME_DATA h_prev_data)
{
  int i;
  ...
  FLC_sub_start("decodeNoiseFloorlevels");
