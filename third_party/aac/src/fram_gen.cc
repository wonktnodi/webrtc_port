/****************************************************************************
 ...
 $Id: fram_gen.c,v 1.1.2.5 2004/02/17 10:21:21 jr Exp $

*******************************************************************************/
/*!
  \file
  \brief  Framing generator $Revision: 1.1.2.5 $
...
{
  FLC_sub_start("createDefFrameInfo");
                      ...
                      )
{
  ...
  FLC_sub_start("ctrlSignal2FrameInfo");
                    ...
                    int *v_tuning)
{
  ...
  FLC_sub_start("frameInfoGenerator");
...

{
  ...
  FLC_sub_start("CreateFrameInfoGenerator");

  FUNC(2); LOOP(1); PTR_INIT(1); MOVE(1); STORE(sizeof(SBR_ENVELOPE_FRAME));
  memset(hSbrEnvFrame,0,sizeof(SBR_ENVELOPE_FRAME ));
...
{
  FLC_sub_start("deleteFrameInfoGenerator");
