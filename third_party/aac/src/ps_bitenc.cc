...
$Id: ps_bitenc.c,v 1.1.2.11 2004/04/01 13:14:17 ehr Exp $

*******************************************************************************/
/*!
\file
\brief  Parametric stereo bitstream encoder $Revision: 1.1.2.11 $
...
int
WritePsData (struct PS_ENC* h_ps_e,
			 int bHeaderActive)
{
	int temp, gr;
