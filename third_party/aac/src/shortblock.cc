/****************************************************************************
 ...
 $Id: shortblock.c,v 1.1.2.5 2004/02/16 15:52:53 ehr Exp $

****************************************************************************/
/*!
  \file
  \brief  decoding of short blocks  $Revision: 1.1.2.5 $
  \author zerok 
*/
...
void CShortBlock_Init(CAacDecoderChannelInfo *pAacDecoderChannelInfo)
{
  ...
  FLC_sub_start("CShortBlock_Init");
                    ...
                    int stride)
{
  ...
  FLC_sub_start("CShortBlock_LongShortLapIllegal");
