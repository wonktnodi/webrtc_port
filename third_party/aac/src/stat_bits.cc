/****************************************************************************
 ...
 $Id: stat_bits.c,v 1.1.2.6 2004/02/16 21:05:58 ehr Exp $
 
****************************************************************************/
/*!
  \file 
  \brief  Static bit counter $Revision: 1.1.2.6 $
  \author M. Werner
*/
#include "stat_bits.h"
#include "bitenc.h"
                         ...
                         int channels)
{
  ...
  FLC_sub_start("countStaticBitdemand");
