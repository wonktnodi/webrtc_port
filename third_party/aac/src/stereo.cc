/****************************************************************************
 ...
 $Id: stereo.c,v 1.1.2.4 2004/02/16 17:53:57 ehr Exp $

****************************************************************************/
/*!
  \file
  \brief  joint stereo processing  $Revision: 1.1.2.4 $
  \author zerok 
*/
                       ...
                       int scaleFactorBandsTransmitted)     /*!< number of transmitted scalefactor bands */
{
  ...
  FLC_sub_start("CJointStereo_Read");
                          ...
                          int scaleFactorBandsTransmitted)                     /*!< number of transmitted scalefactor bands */
{
  ...
  FLC_sub_start("CJointStereo_ApplyMS");
                          ...
                          unsigned char CommonWindow)                        /*!< common window bit */
{
  ...
  FLC_sub_start("CJointStereo_ApplyIS");
