/****************************************************************************
 ...
 $Id: stprepro.c,v 1.1.2.5 2004/02/16 21:05:58 ehr Exp $

****************************************************************************/
/*!
  \file
  \brief  stereo pre-processing $Revision: 1.1.2.5 $
                            ...
                            )
{
  ...
  FLC_sub_start("InitStereoPreProcessing");
                           ...
                           int granuleLen) /*! num. samples to be processed */
{
  ...
  FLC_sub_start("ApplyStereoPreProcess");
...
{
  FLC_sub_start("UpdateStereoPreProcess");
