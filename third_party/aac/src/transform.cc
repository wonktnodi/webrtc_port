/****************************************************************************
 ...
 $Id: transform.c,v 1.1.2.2 2004/02/16 21:05:59 ehr Exp $
 
****************************************************************************/
/*!
  \file 
  \brief  MDCT transform $Revision: 1.1.2.2 $
  \author M. Werner
*/
#include "psy_const.h"
#include "transform.h"
...
static void preModulationDCT(float *x,int m,const float *sineWindow)
{
  ...
  FLC_sub_start("preModulationDCT");
...
static void postModulationDCT(float *x,int m, const float *trigData, int step,int trigDataSize)
{
  ...
  FLC_sub_start("postModulationDCT");
                                 ...
                                 )
{
  ...
  FLC_sub_start("shiftMdctDelayBuffer");
