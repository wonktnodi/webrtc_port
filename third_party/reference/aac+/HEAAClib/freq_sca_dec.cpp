/****************************************************************************
 ...
 $Id: freq_sca.c,v 1.1.2.17 2004/02/17 15:36:16 jr Exp $

*******************************************************************************/
/*!
  \file
  \brief  Frequency scale calculation $Revision: 1.1.2.17 $
  \author Fredrik Henn & Jonas Roden
*/
#include <math.h>
#include <string.h>
#include <assert.h>
...
sbrdecUpdateFreqScale(unsigned char * v_k_master,
                      ...
                      SBR_HEADER_DATA_DEC * hHeaderData)
{
  int      err=0;
  ...
  FLC_sub_start("sbrdecUpdateFreqScale");
                  ...
                  unsigned char xover_band)
{
  ...
  FLC_sub_start("sbrdecUpdateHiRes");
                  ...
                  unsigned char num_hires)
{
  ...
  FLC_sub_start("sbrdecUpdateLoRes");
                      ...
                      unsigned char num_Ref)
{
  ...
  FLC_sub_start("sbrdecDownSampleLoRes");
...
resetFreqBandTables(HANDLE_SBR_HEADER_DATA_DEC hHeaderData)
{
  ...
  FLC_sub_start("resetFreqBandTables");
