/****************************************************************************
 ...
 $Id: invf_est.c,v 1.1.2.6 2004/02/17 16:12:58 kk Exp $

*******************************************************************************/
/*!
  \file
  \brief  Sbr QMF inverse filtering detector $Revision: 1.1.2.6 $
...
const static float quantStepsSbr[4]  = {1, 10, 14, 19};
const static float quantStepsOrig[4] = {0,  3,  7, 10};
const static float nrgBorders[4] =     {25.0f, 30.0f, 35.0f, 40.0f};

const static DETECTOR_PARAMETERS detectorParamsAAC = {
    quantStepsSbr,
    quantStepsOrig,
    nrgBorders,
    4,
...
const static DETECTOR_PARAMETERS detectorParamsAACSpeech = {
    quantStepsSbr,
    quantStepsOrig,
    nrgBorders,
    4,
...
const static FIR_FILTER fir_0 = { 1.0f };
const static FIR_FILTER fir_1 = { 0.3333333f, 0.6666666f };
const static FIR_FILTER fir_2 = { 0.125f, 0.375f, 0.5f };
const static FIR_FILTER fir_3 = { 0.0585786f, 0.2f, 0.3414214f, 0.4f };
const static FIR_FILTER fir_4 = { 0.0318305f, 0.1151638f, 0.2181695f, 0.3015028f, 0.3333333f };

const static FIR_FILTER *fir_table[5] = {
  &fir_0,
  &fir_1,
  &fir_2,
  &fir_3,
                        ...
                        )
{
  ...
  FLC_sub_start("calculateDetectorValues");
                  ...
                  )
{
  ...
  FLC_sub_start("decisionAlgorithm");
                             ...
                             )
{
  ...
  FLC_sub_start("qmfInverseFilteringDetector");
                       ...
                       )
{
  ...
  FLC_sub_start("createInvFiltDetector");
                     ...
                     int numDetectorBands)
{
  ...
  FLC_sub_start("resetInvFiltDetector");
...
{
  FLC_sub_start("deleteInvFiltDetector");
