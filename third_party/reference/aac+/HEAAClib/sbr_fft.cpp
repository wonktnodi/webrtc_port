/****************************************************************************
 ...
 $Id: sbr_fft.c,v 1.1.2.1 2004/02/17 11:42:00 ehr Exp $

*******************************************************************************/
/*!
  \file
  \brief  Fast FFT routines prototypes $Revision: 1.1.2.1 $
  \author Per Ekstrand
*/
#include <string.h>
#include <assert.h>
...
static const float c[4] = { 9.807852804032304e-1,
...
*/
static void fft4(float * restrict vec)
{
...
*/
static void fft32(float * restrict vec)
{
