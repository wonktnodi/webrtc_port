/****************************************************************************
 ...
 $Id: tns.c,v 1.1.2.5 2004/02/16 17:53:57 ehr Exp $

****************************************************************************/
/*!
  \file
  \brief  temporal noise shaping tool  $Revision: 1.1.2.5 $
  \author zerok 
*/
#include <math.h>
                                  ...
                                  float *a)        /*!< pointer to parcor coefficients */
{
  ...
  FLC_sub_start("TnsDecodeCoefficients");
                              ...
                              CAacDecoderChannelInfo *pAacDecoderChannelInfo) /*!< pointer to aac decoder channel info */
{
  ...
  FLC_sub_start("CTns_ReadDataPresentFlag");
