/****************************************************************************
 ...
 $Header: /data/cvs/release/FloatFR_sbrenclib/src/Attic/ton_corr.c,v 1.1.2.9 2004/04/01 13:14:17 ehr Exp $
                               ...
                               )
{
  ...
  FLC_sub_start("calcAutoCorrSecondOrder");
                        ...
                        )
{
  ...
  FLC_sub_start("CalculateTonalityQuotas");
                 ...
                 )
{
  ...
  FLC_sub_start("TonCorrParamExtr");
                        ...
                        )
{
  ...
  FLC_sub_start("CreateTonCorrParamExtr");
  ...
  for(i=0;i<hTonCorr->numberOfEstimates;i++) {
    PTR_INIT(1);
    hTonCorr->quotaMatrix[i] = &(hTonCorr->sbr_quotaMatrix[chan* NO_OF_ESTIMATES*QMF_CHANNELS + i*noQmfChannels]);
...
DeleteTonCorrParamExtr (HANDLE_SBR_TON_CORR_EST hTonCorr)
{
  ...
  FLC_sub_start("DeleteTonCorrParamExtr");
