/****************************************************************************
 ...
 $Id: bit_sbr.c,v 1.1.2.9 2004/05/31 12:50:24 ehr Exp $

*******************************************************************************/
/*!
  \file
  \brief  SBR bit writing routines $Revision: 1.1.2.9 $
  \author Fredrik Henn
*/
#include <stdlib.h>
#include <assert.h>
...
static int encodeSbrHeader (HANDLE_SBR_HEADER_DATA_ENC     sbrHeaderData,
                            HANDLE_SBR_BITSTREAM_DATA  sbrBitstreamData,
                            HANDLE_COMMON_DATA         cmonData,
                            SBR_ELEMENT_TYPE           sbrElem);


static int encodeSbrHeaderData (HANDLE_SBR_HEADER_DATA_ENC sbrHeaderData,
...
*****************************************************************************/
int
WriteEnvSingleChannelElement(HANDLE_SBR_HEADER_DATA_ENC     sbrHeaderData,
                             HANDLE_SBR_BITSTREAM_DATA  sbrBitstreamData,
...

{
  ...
  FLC_sub_start("WriteEnvSingleChannelElement");
...
*****************************************************************************/
int
WriteEnvChannelPairElement (HANDLE_SBR_HEADER_DATA_ENC     sbrHeaderData,
                            HANDLE_SBR_BITSTREAM_DATA  sbrBitstreamData,
...

{
  ...
  FLC_sub_start("WriteEnvChannelPairElement");
...
int
CountSbrChannelPairElement (HANDLE_SBR_HEADER_DATA_ENC     sbrHeaderData,
                            HANDLE_SBR_BITSTREAM_DATA  sbrBitstreamData,
                            HANDLE_SBR_ENV_DATA        sbrEnvDataLeft,
                            HANDLE_SBR_ENV_DATA        sbrEnvDataRight,
                            HANDLE_COMMON_DATA         cmonData)

{
  ...
  FLC_sub_start("CountSbrChannelPairElement");
...
*****************************************************************************/
static int
encodeSbrHeader (HANDLE_SBR_HEADER_DATA_ENC     sbrHeaderData,
                 HANDLE_SBR_BITSTREAM_DATA  sbrBitstreamData,
                 HANDLE_COMMON_DATA         cmonData,
                 SBR_ELEMENT_TYPE           sbrElem)
...
*****************************************************************************/
static int
encodeSbrHeaderData (HANDLE_SBR_HEADER_DATA_ENC sbrHeaderData,
                     HANDLE_BIT_BUF hBitStream,
                     SBR_ELEMENT_TYPE sbrElem)

{
  ...
  FLC_sub_start("encodeSbrHeaderData");
...

{
  ...
  FLC_sub_start("encodeSbrSingleChannelElement");
                             ...
                             int                   coupling)
{
  ...
  FLC_sub_start("encodeSbrChannelPairElement");
...
writeNoiseLevelData (HANDLE_SBR_ENV_DATA sbrEnvData, HANDLE_BIT_BUF hBitStream, int coupling)
{
  ...
  FLC_sub_start("writeNoiseLevelData");
...
writeEnvelopeData (HANDLE_SBR_ENV_DATA sbrEnvData, HANDLE_BIT_BUF hBitStream, int coupling)
{
  ...
  FLC_sub_start("writeEnvelopeData");
                    ...
                    int* payloadBitsReturn)
{
  ...
  FLC_sub_start("encodeExtendedData");
...

{
  ...
  FLC_sub_start("writeSyntheticCodingData");
...

{
  ...
  FLC_sub_start("getSbrExtendedDataSize");
