/****************************************************************************
 ...
 $Id: bitenc.c,v 1.1.2.7 2004/02/16 20:02:18 ehr Exp $
 
****************************************************************************/
/*!
  \file
  \brief  Bitstream encoder $Revision: 1.1.2.7 $
  \author M. Werner
*/
#include <stdio.h>
#include <stdlib.h>
                              ...
                              HANDLE_BIT_BUF      hBitStream)
{
  ...
  FLC_sub_start("encodeSpectralData");
...
static void encodeGlobalGain(int globalGain,
                             ...
                             HANDLE_BIT_BUF hBitStream)
{
  FLC_sub_start("encodeGlobalGain");
                             ...
                             HANDLE_BIT_BUF hBitStream)
{
  ...
  FLC_sub_start("encodeSectionData");
                                 ...
                                 HANDLE_BIT_BUF      hBitStream)
{
  ...
  FLC_sub_start("encodeScaleFactorData");
...
{
  FLC_sub_start("encodeGainControlData");
                             ...
                             TNS_INFO tnsInfo)
{
  ...
  FLC_sub_start("writeIndividualChannelStream");
...
static int writeSingleChannelElement(int instanceTag,
                                     ...
                                     TNS_INFO tnsInfo)
{
  FLC_sub_start("writeSingleChannelElement");
...
{
  FLC_sub_start("writeChannelPairElement");
                             ...
                             HANDLE_BIT_BUF hBitStream)
{
  ...
  FLC_sub_start("writeFillElement");
