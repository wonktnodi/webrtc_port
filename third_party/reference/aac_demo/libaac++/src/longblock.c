/****************************************************************************
 ...
 $Id: longblock.c,v 1.1.2.5 2004/02/16 15:52:53 ehr Exp $

****************************************************************************/
/*!
  \file
  \brief  decoding of long blocks  $Revision: 1.1.2.5 $
  \author zerok 
*/
                               ...
                               CAacDecoderChannelInfo *pAacDecoderChannelInfo)
{
  ...
  FLC_sub_start("CLongBlock_ReadSectionData");
                                    ...
                                    unsigned char global_gain)
{
  ...
  FLC_sub_start("CLongBlock_ReadScaleFactorData");
                                 ...
                                 CAacDecoderChannelInfo *pAacDecoderChannelInfo)
{
  ...
  FLC_sub_start("CLongBlock_ReadSpectralData");
                    ...
                    int stride)
{
  ...
  FLC_sub_start("ShortLongLapIllegal");
                    ...
                    int stride)
{
  ...
  FLC_sub_start("LongShortLapIllegal");
                                ...
                                const int stride)
{
  ...
  FLC_sub_start("CLongBlock_FrequencyToTime");
