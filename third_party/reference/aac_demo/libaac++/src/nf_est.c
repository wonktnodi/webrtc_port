/****************************************************************************
 ...
 $Id: nf_est.c,v 1.1.2.7 2004/04/01 13:14:17 ehr Exp $

*******************************************************************************/
/*!
  \file
  \brief  Noise floor estimation $Revision: 1.1.2.7 $
                        ...
                        const float* smoothFilter)
{
  ...
  FLC_sub_start("smoothingOfNoiseLevels");
                            ...
                            INVF_MODE inverseFilteringLevel)
{
  ...
  FLC_sub_start("qmfBasedNoiseFloorDetection");
...

{
  ...
  FLC_sub_start("sbrNoiseFloorEstimateQmf");
                            ...
                            )
{
  ...
  FLC_sub_start("CreateSbrNoiseFloorEstimate");
  ...
  h_sbrNoiseFloorEstimate->ana_max_level          = (float) pow(2.0f,ana_max_level/3.0f);
  ...
  for(i=0;i<h_sbrNoiseFloorEstimate->noNoiseBands;i++)
  {
    ...
    h_sbrNoiseFloorEstimate->noiseFloorOffset[i] = (float) pow(2.0f,noiseFloorOffset/3.0f);
  }
                            ...
                            int nSfb)
{
  ...
  FLC_sub_start("resetSbrNoiseFloorEstimate");
...
deleteSbrNoiseFloorEstimate (HANDLE_SBR_NOISE_FLOOR_ESTIMATE h_sbrNoiseFloorEstimate)
{
  ...
  FLC_sub_start("deleteSbrNoiseFloorEstimate");
