/****************************************************************************
 ...
 $Id: psy_configuration.c,v 1.1.2.14 2004/02/16 21:05:58 ehr Exp $
 
****************************************************************************/
/*!
  \file 
  \brief  Psychoaccoustic configuration $Revision: 1.1.2.14 $
  \author M. Werner
*/
#include <math.h>
#include <stdio.h>
...
const static SFB_INFO_TAB sfbInfoTab[] ={
                         ...
                         PSY_CONFIGURATION_LONG *psyConf) 
{
  ...
  FLC_sub_start("InitPsyConfiguration");
