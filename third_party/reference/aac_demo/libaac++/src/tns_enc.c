/****************************************************************************
 ...
 $Id: tns.c,v 1.1.2.16 2004/02/16 21:05:59 ehr Exp $
 
****************************************************************************/
/*!
  \file 
  \brief  Temporal Noise Shaping $Revision: 1.1.2.16 $
  \author A. Groeschel
*/
#include "assert.h"
#include "psy_const.h"
                                  ...
                                  const int *bandStartOffset)
{
  ...
  FLC_sub_start("FreqToBandWithRounding");
...
int InitTnsConfiguration(   int bitRate,
                            ...
                            int active) 
{
  FLC_sub_start("InitTnsConfiguration");
...
int InitTnsConfigurationShort(   int bitRate,
                                 ...
                                 int active) 
{
  FLC_sub_start("InitTnsConfigurationShort");
                                 ...
                                 int            lpcStopBand)
{
    ...
    FLC_sub_start("CalcWeightedSpectrum");
                                  ...
                                  float output[])
{
  ...
  FLC_sub_start("AnalysisFilterLattice");
                               ...
                               float *thresholds) 
{
  ...
  FLC_sub_start("ApplyTnsMultTableToRatios");
